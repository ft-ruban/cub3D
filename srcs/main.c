...
// {
// 	texture->img = mlx_xpm_file_to_image(mlx->mlx, path,0,0);
// 	if(!texture->img)
...
// 		return(error_handler(cub3d, TEXTURE_NO_FAIL, "TOFILL", MSG_33));
// 	if(init_img_texture(cub3d->texture->so, cub3d->mlx, cub3d->parsing->rp_so))
// 		return(error_handler(cub3d, TEXTURE_SO_FAIL, "TOFILL", MSG_33));
// 	if(init_img_texture(cub3d->texture->we, cub3d->mlx, cub3d->parsing->rp_we))
// 		return(error_handler(cub3d, TEXTURE_WE_FAIL, "TOFILL", MSG_33));
// 	if(init_img_texture(cub3d->texture->ea, cub3d->mlx, cub3d->parsing->rp_ea))
// 		return(error_handler(cub3d, TEXTURE_EA_FAIL, "TOFILL", MSG_33));
// 	return(RETURN_SUCCESS);
// }
